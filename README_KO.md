...
K-POP 산업 재무 및 비즈니스 데이터 분석을 위한 AI 챗봇입니다.

**언어:** [English](README.md) | [한글 (Korean)](README_KO.md)

## 개요

Ollama의 로컬 LLM(Llama 3.1)과 ChromaDB 벡터 데이터베이스를 활용하여 K-POP 산업 관련 재무 및 비즈니스 데이터를 분석합니다. 프롬프트 기반이 아닌 **벡터 DB 유사도 점수**로 답변의 정확도를 객관적으로 평가합니다.
